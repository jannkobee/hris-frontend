<template>
  ...
  <v-container fluid>
    <div class="d-flex align-center justify-space-between flex-wrap ga-3 mb-4">
      <div>
        <div class="text-h5 font-weight-bold">Job Grade Management</div>
        <p class="text-body-2 text-medium-emphasis mb-0">
          Define and manage the job grades used to classify employee positions.
        </p>
      </div>
      <v-chip color="primary" variant="flat">Job Grades</v-chip>
    </div>
