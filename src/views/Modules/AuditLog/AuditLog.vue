<template>
  <v-container fluid>
    <div class="d-flex align-center justify-space-between flex-wrap ga-3 mb-4">
      <div>
        <div class="text-h5 font-weight-bold">Audit Logs</div>
        <p class="text-body-2 text-medium-emphasis mb-0">
          Track user actions and system changes across all modules.
        </p>
      </div>
      <v-chip color="primary" variant="flat">Audit Trail</v-chip>
    </div>
