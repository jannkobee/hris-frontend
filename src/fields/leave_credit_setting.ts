...
export const fields: ColumnConfig[] = [
  ...
  {
    title: "Eligible Employment Statuses",
    key: "eligible_employment_status_ids",
    inputField: "select",
    selectKey: "eligible_employment_status_ids",
    multiple: true,
    inputOptions: [],
    required: false,
  },
  {
    ...
    key: "eligible_department_ids",
    inputField: "select",
    selectKey: "eligible_department_ids",
    multiple: true,
    inputOptions: [],
    required: false,
  },
  {
    ...
    key: "eligible_position_ids",
    inputField: "select",
    selectKey: "eligible_position_ids",
    multiple: true,
    inputOptions: [],
    required: false,
  },
  {
    title: "Eligible Job Grades",
    key: "eligible_job_grade_ids",
    inputField: "select",
    selectKey: "eligible_job_grade_ids",
    multiple: true,
    inputOptions: [],
    required: false,
  },
  {
    title: "Minimum Service (Months)",
